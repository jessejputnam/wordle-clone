...
// prettier-ignore
const answers = ["ABUSE", "ADIEU", "ADORE", "ADULT", "AGILE", "ALOHA", "AMBER", "AMITY", "AUGHT", "AZURE", "BASIS", "BLOCK", "BLUNT", "BRAIN", "BRUNT", "CABLE", "CHAIN", "CHAIR", "CIVIL", "COACH", "COULD", "CROWN", "DOUBT", "DOZEN", "DRAFT", "DRAMA", "DRAWN", "EAGER", "EARTH", "ENEMY", "EQUAL", "EXTRA", "FAULT", "FIELD", "FIFTH", "FLUID", "FORTH", "GIANT", "GNOME", "GOING", "GRAND", "GUEST", "HAPPY", "HEAVY", "HOTEL", "HUMAN", "IMAGE", "INDEX", "ISSUE", "JOINT", "JUDGE", "KINDS",  "KNOWS", "LOGIC", "LOWER", "LUCKY",  "MAGIC", "MATCH", "MEDIA", "MERIT", "MIXED", "NIGHT", "NOBLE", "NORSE", "NORTH", "NOVEL", "NURSE", "ODORS", "OTHER", "PAILS", "PALED", "PALES", "PANEL", "PANIC", "PIOUS", "PRIZE", "QUICK", "QUIET", "QUITE", "RADIO", "ROBIN", "ROYAL", "RUGBY", "SCOPE", "SCORE", "SHOWN", "SOUND", "STAGE", "THEIR", "THEME", "THOSE", "TOTAL", "TRADE", "UNITY", "URBAN", "USAGE", "VAPID", "VENOM", "VOICE", "WASTE", "WOULD", "WRITE", "YACHT", "YEARN", "YIELD", "YOUNG", "ZESTY", "ZONED",
];
